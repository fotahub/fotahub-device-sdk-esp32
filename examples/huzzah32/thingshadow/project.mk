...
EXTRA_COMPONENT_DIRS += $(PREFIX)/third-party/paho.mqtt.embedded-c
EXTRA_COMPONENT_DIRS += $(PREFIX)/third-party/se.sics.contiki.json
...
$$(PROJECT_PATH)/$(2): 
	wget $$(if $$(V),,-q )-O $$@ $(1)
endef
$(eval $(call DownloadResource,https://www.amazontrust.com/repository/AmazonRootCA1.pem,AmazonRootCA1.pem))
$(eval $(call DownloadResource,https://www.amazontrust.com/repository/AmazonRootCA3.pem,AmazonRootCA3.pem))
$(eval $(call DownloadResource,https://letsencrypt.org/certs/isrgrootx1.pem,isrgrootx1.pem))

component-demoproduct-build: $(PROJECT_PATH)/AmazonRootCA1.pem $(PROJECT_PATH)/AmazonRootCA3.pem $(if $(wildcard $(FOTAHUB_SRCDIR)/fotahub/component.mk),$(PROJECT_PATH)/isrgrootx1.pem,)
